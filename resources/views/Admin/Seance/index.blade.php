                                            ...
                                            <div class="fixed inset-0 z-[999] hidden overflow-y-auto bg-[black]/60" :class="open && '!block'">
                                                <div class="flex min-h-screen items-start justify-center px-4" @click.self="open = false">
                                                    <div x-show="open" x-transition="" x-transition.duration.300="" class="panel my-8 w-full max-w-[300px] overflow-hidden rounded-lg border-0 bg-secondary p-0 dark:bg-secondary">
                                                        <div class="panel">
                                                            <div class="mb-10 flex items-center justify-between">
                                                                <h5 class="text-lg font-semibold dark:text-white-light">Elèves Présents</h5>
                                                            ...
                                                            <div class="group">
                                                                <ul class="mb-7 list-inside list-disc space-y-2 font-semibold text-white-dark">
                                                                    @forelse($seance->presents as $eleve )
                                                                        <li class="flex space-between">{{$eleve->nom_pr_eleve_fr}}<span> {{$eleve->nom_pr_eleve_ar}}</span></li>
                                                                ...
                                                                <div class="mb-5 h-2.5 flex justify-center ">
                                                                    <button type="button" class="btn btn-warning rounded-full">
                                                                        ...
                                                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 shrink-0 ltr:ml-1.5 rtl:mr-1.5">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.btngroupe').change(function(){
                ...
                $('#mytable > tbody:last-child').append('<tr style="height: 10px;vertical-align:middle"><td><input name="presents[]" type="checkbox" class="form-checkbox" value="'+eleve.id+'" /></td><td >'+eleve.nom_pr_eleve_ar+'</td><td >'+eleve.nom_pr_eleve_fr+'</td></tr>');
