                                                ...
                                                <form class="space-y-5" method="post"
                                                    ...
                                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        <div>
                                                            ...
                                                            <input type="text" placeholder="Nom et prénom"
                                                                name="nom_pr_eleve_fr" class="form-input" />
                                                        </div>
                                                        <div>
                                                    ...
                                                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        ...
                                                        <div class="flex">
                                                            ...
                                                            <input type="text" name="tel_parent"
                                                        ...
                                                        <div>
                                                            <label for="id_label_single">
                                                                ...
                                                                <select class="form-select text-white-dark groupes"
                                                                    id="groupes" name="groupes[]" multiple="multiple"
                                                                    style="width: 100%">
                                            ...
                                            <tr class="{{ $eleve['toutesPayees'] ? 'bg-success-light ' : 'bg-warning-light ' }}">
                                                ...
                                                <td
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div>
                                                                                    ...
                                                                                    <input id="nom_pr_eleve_ar"
                                                                                        ...
                                                                                        class="form-input nom_pr_eleve_ar" />
                                                                                </div>
                                                                            </div>
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <div class="flex">
                                                                                    ...
                                                                                    <input id="tel" type="text"
                                                                                        ...
                                                                                        class="form-input ltr:rounded-l-none rtl:rounded-r-none tel">
                                                                                </div>
                                                                                <div class="flex">
                                                                                    <div
                                                                                        class="flex items-center justify-center border border-[#e0e6ed] bg-[#eee] px-3 font-semibold ltr:rounded-l-md ltr:border-r-0 rtl:rounded-r-md rtl:border-l-0 dark:border-[#17263c] dark:bg-[#1b2e4b]">
                                                                            ...
                                                                            <div class="relative mb-4">
                                                                                ...
                                                                                <div>
                                                                                    <label for="id_label_single">
                                                                                        Choisir les groupes
                                                                                        <select
                                                                                            class="form-select text-white-dark groupes groupes-{{ $eleve->id }} "
                                                                                            id="groupes{{ $eleve->id }} "
                                                                                            multiple="multiple"
                                                                                            style="width: 100%">
                                                    ...
                                                    <form action="{{ route('eleves.destroy', $eleve->id) }}"
                                                        id="delete-form-{{ $eleve->id }}" method="post"
                                                        class="inline-block">
                                                        @csrf
                                                        @method('DELETE')
