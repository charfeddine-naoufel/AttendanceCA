                                            ...
                                            <div class="p-5">
                                                <form method="post" action="{{ route('matieres.store') }}">
                                                    ...
                                                    <div class="relative mb-4">
                                                        ...
                                                        <input type="text" placeholder="Nom matière"name="nom_mat_fr"
                                                    ...
                                                    <div class="relative mb-4">
                                                        ...
                                                        <input type="text" placeholder="اسم المادة"name="nom_mat_ar"
                                                            class="form-input ltr:pl-10 rtl:pr-10">
                                                    </div>
                                                                        ...
                                                                        <form>
                                                                            ...
                                                                            <div class="relative mb-4">
                                                                                ...
                                                                                <input type="text"
                                                                                    ...
                                                                                    name="nom_mat_fr"
                                                                                    id="nom_mat_fr{{ $matiere->id }}"
                                                                                    class="form-input ltr:pl-10 rtl:pr-10">
                                                                                <input type="hidden" class="form-control"
                                                                                    id="IdMatiere" name="IdMatiere">
                                                                            </div>
                                                                            <div class="relative mb-4">
                                                                                <span
                                                                                    class="absolute top-1/2 -translate-y-1/2 ltr:left-3 rtl:right-3 dark:text-white-dark">
                                                                                ...
                                                                                <input type="text"
                                                                                    placeholder="اسم المادة"name="nom_mat_ar"
                                                                                    id="nom_mat_ar{{ $matiere->id }}"
                                                                                    class="form-input ltr:pl-10 rtl:pr-10">
                                                                            </div>
