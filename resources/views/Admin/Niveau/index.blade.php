                                                ...
                                                <form method="post" action="{{ route('niveaux.store') }}">
                                                   @csrf
                                                    <div class="relative mb-4">
                                                        ...
                                                        <input type="text" placeholder="Nom niveau"name="nom_niv_fr" class="form-input ltr:pl-10 rtl:pr-10">
                                                    </div>
                                                    <div class="relative mb-4">
                                                        <span class="absolute top-1/2 -translate-y-1/2 ltr:left-3 rtl:right-3 dark:text-white-dark">
                                                            <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                                        ...
                                                        <input type="text" placeholder="المستوى "name="nom_niv_ar" class="form-input ltr:pl-10 rtl:pr-10">
                                                    </div>
                                ...
                                <tbody>
                                    @foreach($niveaux as $niveau)
                                        ...
                                        <tr>
                                            ...
                                            <td >{{$niveau->nom_niv_fr}}</td>
                                            <td >{{$niveau->nom_niv_ar}}</td>
                                            <td class="border-b border-[#ebedf2] p-3 text-center dark:border-[#191e3a]">
                                                
                                                {{-- edit --}}
                                                <div x-data="modal" class="inline-block">
                                                    <button type="button"  @click="toggle" data-id="{{$niveau->id}}" class="btn-outline-success editbtn ">
                                                                ...
                                                                <div class="p-5">
                                                                    <form >
                                                                        ...
                                                                        <div class="relative mb-4">
                                                                            ...
                                                                            <input type="text" placeholder="Nom niveau" name="nom_niv_fr" id="nom_niv_fr{{$niveau->id}}" class="form-input ltr:pl-10 rtl:pr-10">
                                                                            <input type="hidden" class="form-control" id="IdNiveau" name="IdNiveau">
                                                                        </div>
                                                                        <div class="relative mb-4">
                                                                            <span class="absolute top-1/2 -translate-y-1/2 ltr:left-3 rtl:right-3 dark:text-white-dark">
                                                                                <svg width="24" height="24" viewbox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-5 w-5">
                                                                            ...
                                                                            <input type="text" placeholder="اسم "name="nom_niv_ar" id="nom_niv_ar{{$niveau->id}}" class="form-input ltr:pl-10 rtl:pr-10">
                                                                        </div>
                                                ...
                                                <form action="{{ route('niveaux.destroy', $niveau->id)}}" method="post" class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
...
<script type="module">
    ...
    $('.editbtn').on('click', function(e) {
                ...
                $.get("niveaux/" + id + "/edit", function(data) {
                    console.log(data.data);
                    $('#nom_niv_fr'+ id).val(data.data['nom_niv_fr']);
                    $('#nom_niv_ar'+ id).val(data.data['nom_niv_ar']);
                    $('#IdNiveau').val(data.data['id']);
            ...
            $('.updatebtn').on('click', function(e) {
                e.preventDefault();
                var id = $('#IdNiveau').val();
                var nom_niv_fr = $('#nom_niv_fr'+ id).val();
                var nom_niv_ar = $('#nom_niv_ar'+ id).val();
                var id = $('#IdNiveau').val();
                ...
                $.ajax({
                    ...
                    data: { id: id,
                        nom_niv_fr: nom_niv_fr,
                        nom_niv_ar: nom_niv_ar },
