                ...
                <div class="mb-5 grid grid-cols-1 gap-5 lg:grid-cols-12 xl:grid-cols-12">
                    ...
                    <div class="panel lg:col-span-2 xl:col-span-3">
                        <div class="mb-10 flex items-center justify-between">
                            ...
                            <!-- Register -->
                            <div x-data="modal">
                                <button type="button" class="btn btn-danger" @click="toggle"><svg fill="none"
                                            ...
                                            <div class="p-5">
                                                <form method="post" action="{{ route('niveaux.store') }}">
                                                    ...
                                                    <div class="relative mb-4">
                                                        ...
                                                        <input type="text" placeholder="Nom niveau"name="nom_niv_fr"
                                                    ...
                                                    <div class="relative mb-4">
                                                        ...
                                                        <input type="text" placeholder="المستوى "name="nom_niv_ar"
                                                            class="form-input ltr:pl-10 rtl:pr-10">
                                                    </div>
                                                                        ...
                                                                        <form>
                                                                            ...
                                                                            <div class="relative mb-4">
                                                                                ...
                                                                                <input type="text"
                                                                                    ...
                                                                                    name="nom_niv_fr"
                                                                                    id="nom_niv_fr{{ $niveau->id }}"
                                                                                    class="form-input ltr:pl-10 rtl:pr-10">
                                                                                <input type="hidden" class="form-control"
                                                                                    id="IdNiveau" name="IdNiveau">
                                                                            </div>
                                                                            <div class="relative mb-4">
                                                                                <span
                                                                                    class="absolute top-1/2 -translate-y-1/2 ltr:left-3 rtl:right-3 dark:text-white-dark">
                                                                                ...
                                                                                <input type="text"
                                                                                    placeholder="اسم "name="nom_niv_ar"
                                                                                    id="nom_niv_ar{{ $niveau->id }}"
                                                                                    class="form-input ltr:pl-10 rtl:pr-10">
                                                                            </div>
