                                            ...
                                            <div class="p-5">
                                                <form method="post" action="{{ route('groupes.store') }}">
                                                    ...
                                                    <div class="relative mb-4">
                                                        ...
                                                        <input type="text" placeholder="Nom groupe"name="nom_groupe"
                                                    ...
                                                    <div class="relative mb-4">
                                                        ...
                                                        <div>
                                                            <select class="form-select text-white-dark" name="niveau_id">
                                                    ...
                                                    <div class="relative mb-4">
                                                        ...
                                                        <div>
                                                            <select class="form-select text-white-dark" name="matiere_id">
