                    ...
                    <div class="relative flex w-full max-w-[1502px] flex-col justify-between overflow-hidden rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 lg:min-h-[758px] lg:flex-row lg:gap-10 xl:gap-0">
                        <div class="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,rgba(239,18,98,1)_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-32 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                            ...
                            <div class="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                                <a href="index.html" class="block w-48 lg:w-72 ms-10">
                                    <img src="{{asset('assets/images/logo.png')}}" alt="Logo" class="w-full">
                                </a>
                        ...
                        <div class="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                            <div class="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                                ...
                                <div class="dropdown ms-auto w-max" x-data="dropdown" >
                        @guest
                            <div></div>
                        @else
                        ...
                        @endguest 
                            ...
                            <div class="w-full max-w-[440px] lg:mt-16">
                                <div class="mb-10">
                                    ...
                                    <p class="text-base font-bold leading-normal text-white-dark">Entrer votre Email et mot de passe </p>
                                </div>
                                <form class="space-y-5 dark:text-white" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="Email" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder=" Email" class="form-input ps-10 placeholder:text-white-dark">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative text-white-dark">
                                            <input id="Password" type="password" name="password" required autocomplete="current-password" placeholder="Mot de passe" class="form-input ps-10 placeholder:text-white-dark">
                                            <span class="absolute start-4 top-1/2 -translate-y-1/2">
                                                <svg width="18" height="18" viewbox="0 0 18 18" fill="none">
                                ...
                                <div class="relative my-7 text-center md:mb-9">
                                    ...
                                    <span class="relative bg-white px-2 font-bold uppercase text-white-dark dark:bg-dark dark:text-white-light">ou bien</span>
                                </div>
                            ...
                            <p class="absolute bottom-6 w-full text-center dark:text-white">
                                © <span id="footer-year">2024</span>. NaCh All Rights Reserved.
                            </p>
                        </div>
                    </div>
                </div>
